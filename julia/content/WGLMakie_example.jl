...
# ╔═╡ 06476be0-ab9a-11ec-076c-1121ed817f31
begin
	using JSServe
	Page(exportable=true, offline=true, listen_url="0.0.0.0")
end

# ╔═╡ a3e1db25-f2b1-471a-9d2a-35077728b8de
begin
	using WGLMakie
	WGLMakie.activate!()
end
...
# ╔═╡ ab131e64-4a6c-4a34-b5e2-bb7e110e84ac
JSServe.JSSERVE_CONFIGURATION
